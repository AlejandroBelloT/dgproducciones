...
import ImageUploadPreview from '../shared/ImageUploadDebug'
...
export default function ProjectForm({
    ...
    // Inicializar mainImage si no existe
    if (formData.mainImage === undefined && formData.images && formData.images.length > 0) {
        setFormData({ ...formData, mainImage: 0 })
    }
    ...
    // Nuevo: campo para imagen principal
                    ...
                    <div>
                        <ImageUploadPreview
                            onImagesChange={(images) => {
                                ...
                                // Auto-seleccionar la primera imagen como principal si no hay una seleccionada
                                if (images.length > 0 && (formData.mainImage === undefined || formData.mainImage === null)) {
                                    setFormData(prev => ({ ...prev, mainImage: 0 }))
                                }
                            }}
                            maxImages={30}
                            disabled={submitting}
                            showMainImageSelector={true}
                            mainImageIndex={formData.mainImage ?? 0}
